YAML = function () {
  ...
  function s() {
    ...
    try {
      ...
      var n = new Array("MSXML2.XMLHTTP.5.0", "MSXML2.XMLHTTP.4.0", "MSXML2.XMLHTTP.3.0", "MSXML2.XMLHTTP", "Microsoft.XMLHTTP");
      var r = false;
      for (var i = 0; i < n.length && !r; i++) {
        try {
          e = new ActiveXObject(n[i]);
          r = true
        } catch (t) {}
      }
      if (!r) {
      ...
      if (a > f) {
        ...
        for (; b >= 0; --b) {
          if (p[b] == a) {
            ...
            l.push(h);
            p.push(a);
            if (l[b].parent != null) l[b].parent.addChild(h);
            y = true;
            break
          }
        }
        if (!y) {
          e.push("Error: Invalid indentation at line " + v + ": " + d);
          return
        }
      }
      h.lines.push(d.replace(r["trim"], ""));
      f = a
    }
    return c
  }
  ...
  function a(e) {
    ...
    if (e == "true") {
      ...
      var o = "";
      var u = false;
      for (var f = 0, l = t[1].length; f < l; ++f) {
        s = t[1][f];
        if (s == "'" || s == '"') {
          if (u === false) {
            u = s;
        ...
        if (i = w.match(r["key"])) {
          ...
          if (typeof i[2] != "undefined") {
            ...
            if (S[0] == "&") {
              ...
              if (h != null) h[E] = l(u.shift());
              else s[E] = l(u.shift())
            } else if (S[0] == "*") {
              var T = S.substr(1);
              var N = {};
              if (typeof t[T] == "undefined") {
                e.push("Reference '" + T + "' not found!")
              } else {
                for (var C in t[T]) {
                  N[C] = t[T][C]
                }
    ...
    for (var s in n) {
      if (t = n[s].match(i)) {
        if (typeof t[3] !== "undefined") {
          n[s] = t[0].substr(0, t[0].length - t[3].length)
        }
      }
    }
    return n.join("\n")
