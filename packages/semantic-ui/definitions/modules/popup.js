...
(function ($, window, document, undefined) {
  ...
  $.fn.popup = function (parameters) {
    ...
    $allModules
      .each(function () {
        var
          settings = ($.isPlainObject(parameters)) ? $.extend(true, {}, $.fn.popup.settings, parameters) : $.extend({}, $.fn.popup.settings),
        ...
        module = {
          ...
          event: {
            start: function (event) {
              var
                delay = ($.isPlainObject(settings.delay)) ? settings.delay.show : settings.delay;
              clearTimeout(module.hideTimer);
              ...
              var
                delay = ($.isPlainObject(settings.delay)) ? settings.delay.hide : settings.delay;
              clearTimeout(module.showTimer);
          ...
          get: {
            ...
            offsetParent: function ($target) {
              var
                element = ($target !== undefined) ? $target[0] : $module[0],
            ...
            position: function (position, arrowOffset) {
              ...
              if (offstagePosition) {
                ...
                if (searchDepth < settings.maxSearchDepth) {
                  ...
                  return ($popup) ? module.set.position(position) : false;
