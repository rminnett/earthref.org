...
(function ($, window, document, undefined) {
  ...
  $.api = $.fn.api = function (parameters) {
    ...
    $allModules
      .each(function () {
        var
          settings = ($.isPlainObject(parameters)) ? $.extend(true, {}, $.fn.api.settings, parameters) : $.extend({}, $.fn.api.settings),
          ...
          event: {
            ...
            request: {
              ...
              error: function (xhr, status, httpMessage) {
                var
                  errorMessage = (settings.error[status] !== undefined) ? settings.error[status] : httpMessage,
                  response;
